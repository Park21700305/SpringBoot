package com.park.springboot.practice.aop;
...
public class PerformanceAspect {
    @Pointcut("@annotation(com.park.springboot.practice.annotation.RunningTime)")
    private void enableRunningTime() {}
    @Pointcut("execution(* com.park.springboot.practice..*.*(..))")
    private void cut() {}
